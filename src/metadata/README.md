 ...
 * [HOSO.yml](HOSO.yml)
     * Determines how your purl.obolibrary.org/obo/HOSO/ redirects will be handled
     ...
     * Paste in the contents of [HOSO.yml](HOSO.yml)
 ...
 * [HOSO.md](HOSO.md)
     ...
     * Paste in the contents of [HOSO.md](HOSO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
